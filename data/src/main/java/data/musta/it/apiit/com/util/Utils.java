...
//    Calligrapher calligrapher;
    ...
    public static Utils getInstance(Application app) {
        if(ourInstance == null)
            ourInstance = new Utils(app);
        return ourInstance;
    }
    ...
    public static boolean isNetworkAvailable(Context context) {
        if (context == null && app.getApplicationContext() != null) {
    ...
    public final void showToast(String toast) {
        if (toast != null) {
            Toast toast1 = Toast.makeText(app.getApplicationContext(), toast, Toast.LENGTH_LONG);
//            toast1.setGravity(Gravity.CENTER, 0, 0);
    ...
    public void copytoClipboard(String str) {
        try {
            if (str != null) {
                ClipboardManager clipboard = (ClipboardManager) app.getApplicationContext().getSystemService(Context.CLIPBOARD_SERVICE);
    ...
    float converDPtoPx(int dp) {
        Resources r = app.getApplicationContext().getResources();
