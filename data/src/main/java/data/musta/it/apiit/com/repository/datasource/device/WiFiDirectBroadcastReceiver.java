 ...
 */
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver implements WifiBroadcastReceiver {
     ...
     * @param deviceWifiP2PRetriever
     */
    public WiFiDirectBroadcastReceiver(WifiP2pManager manager, Channel channel,
                                       WifiActivity activity, DeviceWifiP2PRetriever deviceWifiP2PRetriever) {
        super();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (manager != null) {
                manager.requestPeers(channel, deviceWifiP2PRetriever);
            }
            ...
            if (networkInfo.isConnected()) {
                ...
                manager.requestConnectionInfo(channel, deviceWifiP2PRetriever);
            } else {
                // It's a disconnect
                activity.resetData();
            }
