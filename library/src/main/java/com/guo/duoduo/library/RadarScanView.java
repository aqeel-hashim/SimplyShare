...
public class RadarScanView extends View
{
    ...
    private int radarColor = Color.parseColor("#99ffffff");
    private int tailColor = Color.parseColor("#50ffffff");
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        Shader shader = new SweepGradient(centerX, centerY, Color.parseColor("#00FFFFFF"),
